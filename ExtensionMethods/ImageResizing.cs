...
namespace Umbraco.Community.ExtensionMethods.ImageResizing
{
    public static class ImageResizing
    {
        //ImageResizing URL Helper
        /*
        public static string ImageResizingURL(this string imageURL, int width, int height)
        {
            //Base URL
